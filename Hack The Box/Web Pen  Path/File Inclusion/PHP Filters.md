...
```shell-session
underhill341@htb[/htb]$ ffuf -w /opt/useful/seclists/Discovery/Web-Content/directory-list-2.3-small.txt:FUZZ -u http://<SERVER_IP>:<PORT>/FUZZ.php
...
![Shipping containers and cranes at a port.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/23/lfi_config_failed.png)
...
```shell-session
underhill341@htb[/htb]$ echo 'PD9waHAK...SNIP...KICB9Ciov' | base64 -d
