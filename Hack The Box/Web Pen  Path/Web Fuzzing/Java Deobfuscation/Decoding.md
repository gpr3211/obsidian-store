...
```shell-session
underhill341@htb[/htb]$ curl http://SERVER_IP:PORT/serial.php -X POST -d "param1=sample"
...
```shell-session
underhill341@htb[/htb]$ echo https://www.hackthebox.eu/ | base64
...
```shell-session
underhill341@htb[/htb]$ echo aHR0cHM6Ly93d3cuaGFja3RoZWJveC5ldS8K | base64 -d
...
```shell-session
underhill341@htb[/htb]$ echo https://www.hackthebox.eu/ | xxd -p
...
```shell-session
underhill341@htb[/htb]$ echo 68747470733a2f2f7777772e6861636b746865626f782e65752f0a | xxd -p -r
...
```shell-session
underhill341@htb[/htb]$ echo https://www.hackthebox.eu/ | tr 'A-Za-z' 'N-ZA-Mn-za-m'
...
```shell-session
underhill341@htb[/htb]$ echo uggcf://jjj.unpxgurobk.rh/ | tr 'A-Za-z' 'N-ZA-Mn-za-m'
