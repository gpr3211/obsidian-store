...
![Obfuscated JavaScript code output with 'HTB JavaScript Deobfuscation Module' message.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/41/js_deobf_jsf.jpg)
